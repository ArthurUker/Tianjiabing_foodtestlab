...
> 🗄️ **已归档（2026-08-31）**：本文件是 2026-08-24 的一次性过程稿，内容已全部并入根目录 `README.md`，
> 并从仓库根目录移入 `docs/archive/`。**其中部分口径已过时**（例如文中出现的后端端口 `3000`，生产实为 **3002**；
> 开发/测试环境已于 2026-08-27 下线删除）。**以根目录 `README.md` 为唯一权威文档**，本文件仅供过程追溯。
