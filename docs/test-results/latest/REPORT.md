...
> 生成时间：2026-08-13 17:25（数据源：数据库 `public."TestResult"`）
...
| 曾水平 · 备份与恢复模块（第四部分 B1-B9） | 2 | 0 | 0 | 9 | 2/11 | 18% |
| 历史测试问题 | 0 | 0 | 0 | 28 | 0/28 | 0% |
| 新问题 / 缺陷反馈 | 0 | 5 | 0 | 0 | 5/5 | 100% |
| **合计** | **3** | **5** | **0** | **53** | **8/61** | **13%** |
...
| **Q1-果蔬阶段B** Q1 复检显示·果蔬农残（阶段B 刷新） | ✅ 通过 | wuxiangjun | 2026-08-13 17:24 |
...
| 用例 | 结果 | 提交人 | 最近更新 |
|---|---:|---|---|
| **B1** B1 入口权限（超管可入+运维备份 Tab 可见 / 非超管整页拦截） | ✅ 通过 | wuxiangjun | 2026-08-13 17:24 |
| **B2** B2 备份列表显示 | ✅ 通过 | wuxiangjun | 2026-08-13 17:24 |
...
| 用例 | 结果 | 提交人 | 最近更新 |
|---|---:|---|---|
| **NEW-20260813-170443** 在超管平台上，tjb账户用户管理修改账户的类别失败 | ❌ 失败 | 吴翠楠 | 2026-08-13 17:04 |
...
- **NEW-20260813-170443**（失败）
  - 证据图：![在超管平台上，tjb账户用户管理修改账户的类别失败](evidence/NEW-20260813-170443/1786611893650_6bdfd99a.png)
