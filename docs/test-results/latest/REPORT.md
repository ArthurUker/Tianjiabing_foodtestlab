...
> 生成时间：2026-08-13 15:39（数据源：数据库 `public."TestResult"`）
...
| **Q1-果蔬阶段B** Q1 复检显示·果蔬农残（阶段B 刷新） | ✅ 通过 | wuxiangjun | 2026-08-13 15:39 |
...
| 用例 | 结果 | 提交人 | 最近更新 |
|---|---:|---|---|
| **B1** B1 入口权限（超管可入+运维备份 Tab 可见 / 非超管整页拦截） | ✅ 通过 | wuxiangjun | 2026-08-13 15:39 |
| **B2** B2 备份列表显示 | ✅ 通过 | wuxiangjun | 2026-08-13 15:39 |
